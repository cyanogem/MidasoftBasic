...
namespace BaseDeDatos
{
    ...
    public class ConexionSQLServer 
    {
        ...
        {
            return new SqlConnection("data source=DESKTOP-FM45NHE;initial catalog=PostComment;persist security info=True;Integrated Security=True;");
        }
        public static string cadenaConexion = "data source=DESKTOP-FM45NHE;initial catalog=PostComment;persist security info=True;Integrated Security=True;";
